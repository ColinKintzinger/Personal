...
public:
	...
	LinkedBinarySearchTree<string> getFeaturesList() const {
...
private:
	...
	LinkedBinarySearchTree<string> otherFeaturesList; 
...
public:
	...
	LinkedBinarySearchTree<Vehicle>::Iterator checkID(int);
...
private:
	...
	LinkedBinarySearchTree<Vehicle>v_List;

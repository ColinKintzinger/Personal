...
// Some portions of code are adopted from the course text
#ifndef NODELIST
#define NODELIST
...
public:
	...
	NodeList<Elem>& operator=(const NodeList<Elem>&); //overloading assignment operator
